...
export const metadata = {
  title: "FAQ | BackRow",
  description: "Answers to everything about BackRow.",
};
      ...
      <div className="max-w-3xl mx-auto px-4 lg:px-6 py-8">
        <header className="mb-10">
          ...
          <nav aria-label="FAQ sections" className="mt-6">
            <ol
              className="list-decimal list-inside text-sm text-[var(--text-secondary)] marker:text-[var(--text-muted)] columns-1 sm:columns-2 lg:columns-3 gap-x-8"
            >
              ...
              >
                ...
                <div className="border-t border-[var(--border)]">
                  {sorted.map((item) => (
                    <details
                      key={item.id}
                      className="group py-4 border-b border-[var(--border)]"
                    >
