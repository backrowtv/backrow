                  ...
                  {selectedRubric.categories.map((category) => (
                    <div key={category.id} className="space-y-1">
                      ...
                      <input
                        ...
                        disabled={isSubmitting}
                        className="w-full h-1.5 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--primary)] [&::-webkit-slider-thumb]:cursor-pointer"
                        style={{
