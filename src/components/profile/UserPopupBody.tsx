...
export function UserPopupBody({ userId, open, onClose }: UserPopupBodyProps) {
  ...
  if (isBlocked && !loading) {
    return (
      <div className="bg-[var(--card)] rounded-2xl p-6 border border-[var(--border)] shadow-[var(--shadow-xl)] text-center">
        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-4">User Blocked</h2>
          ...
          <div className="flex items-center justify-end px-1">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-[var(--text-muted)]">
